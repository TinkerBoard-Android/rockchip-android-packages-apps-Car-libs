...
@file:JvmName("ScanDataAnalyzer")

package com.android.car.connecteddevice.util

import java.math.BigInteger

private const val TAG = "ScanDataAnalyzer"
...
private const val IOS_OVERFLOW_CONTENT_LENGTH =
    IOS_OVERFLOW_LENGTH - IOS_OVERFLOW_CUSTOM_ID_LENGTH - IOS_ADVERTISING_TYPE_LENGTH

/**
 * Returns `true` if the given bytes from a [ScanResult] contains service UUIDs once the given
 * `serviceUuidMask` is applied.
 *
