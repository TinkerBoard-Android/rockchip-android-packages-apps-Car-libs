...
# Include car-list
ifeq (,$(findstring car-list, $(LOCAL_STATIC_JAVA_LIBRARIES)))
LOCAL_RESOURCE_DIR += \
    packages/apps/Car/libs/car-list/res
LOCAL_AAPT_FLAGS += --extra-packages com.android.car.list
LOCAL_STATIC_JAVA_LIBRARIES += car-list
endif