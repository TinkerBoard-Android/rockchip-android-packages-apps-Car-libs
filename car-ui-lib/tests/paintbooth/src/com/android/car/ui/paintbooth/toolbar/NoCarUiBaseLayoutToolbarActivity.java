...
/**
 * Activity that uses carUI toolbar but not the base layout. This is a blank activity used for
 * testing.
 */
public class NoCarUiBaseLayoutToolbarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.no_car_ui_baselayout_toolbar_activity);
