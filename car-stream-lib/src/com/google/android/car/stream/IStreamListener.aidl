...
oneway interface IStreamListener {
    /** Called when a new StreamCard is added */
    void onStreamCardAdded(in StreamCard card);
    /** Called when a StreamCard is removed */
    void onStreamCardRemoved(in StreamCard card);
    /** Called when an existing StreamCard is updated */
    void onStreamCardChanged(in StreamCard oldStreamCard, in StreamCard newStreamCard);
}